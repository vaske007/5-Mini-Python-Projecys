# Chooses how long you are going to code, based on how much time you have
...
random_time = random.randint(0, how_much_time_do_you_have)

print(time_to_code[random_time])